...
public static class UiTextRenderer
{
    public static (Vector2 Size, Matrix4x4 World) Draw(
        ...
        Vector4 clip, Matrix4x4? view = null)
    {
        ...
        DrawEntry(draw, item, layout.Size, layout.World, clip, view);
        return layout;
    }
        ...
        Vector4 clip, Matrix4x4? view = null)
    {
        ...
        draw.Text(text.Content, text.FontSize, size.X, text.LineSpacing, matrix, new Vector4(color.R, color.G, color.B, color.A), clip);
    }
}