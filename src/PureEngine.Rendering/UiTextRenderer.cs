...
public static class UiTextRenderer
{
    public static (Vector2 Size, Matrix4x4 World) Draw(
        ...
        Vector4 clip, Matrix4x4? view = null, LocalizationService? localization = null, LocalizationStore? strings = null)
    {
        ...
        DrawEntry(draw, item, layout.Size, layout.World, clip, view, localization, strings);
        return layout;
    }
        ...
        Vector4 clip, Matrix4x4? view = null, LocalizationService? localization = null, LocalizationStore? strings = null)
    {
        ...
        var content = LocalizationService.ResolveText(strings, text.LocalizedEntry, text.Content, localization?.CurrentLanguage);
