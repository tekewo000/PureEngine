...
public partial class MainWindow
{
    ...
    private void DrawSceneView(DrawList draw, System.Numerics.Vector2 size)
    {
        ...
        var diagnostics = EditSceneRenderer.AppendWithLayouts(draw, layouts, _previewImages, viewportSize, view, ViewModel.Localization.PreviewService, Documents.Current.Current.Localization);
